...
<body>
	...
	<div class="cabecalho" id="dvcab">
			<div class="procura">
				<form action="buscadestdata.php" method="POST">
					<table class="tbcont">
						<tr>
							<td>Data da Recarga.: </td>
							<td class="tbentra"><input class="entra" type="date" name="datarec" placeholder="dd-mm-yyyy"></td>
						</tr>
						<tr></tr>
					</table>
					<br>
					<div class="executa">	
						<button class="botao" name="novaetiqueta" value="novaetiqueta"><a href="destina.php"> Voltar</a></button>
