...
<head> 
	...
	<title>Fastcomp - Destinação por Data</title>
</head>
<body>
	...
	<div class="procura">
			<form action="buscadestdata.php" method="POST">
				<p>Data da Recarga.: <input type="date" name="datarec" placeholder="dd-mm-yyyy"> </p>
 		      	<p>&emsp;</p>
 		      	<button class="botao" name="voltar" value="Voltar" ><a href="destina.php"> Voltar</a> </button>
